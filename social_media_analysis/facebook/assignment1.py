...
# def get_high_frequency_5_chr(freq):
#     characters=[key for key,val in freq.items()][-5:]
#     return characters

# file_encrypter("C:/Users/Dane/Desktop/data.txt","C:/Users/Dane/Desktop/encrypted.txt")

# freq=frequency_finder("C:/Users/Dane/Desktop/encrypted.txt")

# print (freq)

# print (get_high_frequency_5_chr(freq))
...
decrypt_function={'W':'E','C':'T','X':'A','L':'O','R':'I'}
